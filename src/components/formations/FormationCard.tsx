...
export function FormationCard({ formation, onViewDetails, onEdit, onDelete }: FormationCardProps) {
  ...
  return (
    ...
    >
      <Card className="h-full shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden">
        <div className="h-2" style={{ backgroundColor: "#1D4ED8" }}></div>
          ...
          <div className="space-y-3 mb-4">
            ...
            {formation._count && (
              <div className="flex items-center gap-2 text-sm">
                ...
                <span>{formation._count.prospects} prospect(s)</span>
              </div>
            )}
          </div>
