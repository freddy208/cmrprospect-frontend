...
// src/components/simulateurs/SimulateurFilters.tsx
"use client";
...
import { SimulateurFilter } from "@/types/simulateur";
...
interface SimulateurFiltersProps {
  filters: SimulateurFilter;
  onFilter: (filters: SimulateurFilter) => void;
  currentUser: any;
}

export function SimulateurFilters({ filters, onFilter, currentUser }: SimulateurFiltersProps) {
  const [localFilters, setLocalFilters] = useState<SimulateurFilter>(filters);
  ...
  const filteredStatuses = useMemo(() => {
    if (!statusSearch) return Object.entries(SIMULATEUR_STATUS);
    return Object.entries(SIMULATEUR_STATUS).filter(([key, value]) => 
